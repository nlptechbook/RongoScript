...
При этом следует учитывать и сказуемое 'полагаю', поскольку оно показывает насколько пользователь привержен утверждению в придаточном предложении. Другими словами необходимо выполнить более сложную, «умную» обработку ввода. 

>**Примечание:** Чтобы получить  представление о лежащей в основе технологии, ознакомтесь с [Russian Commitment Bank](https://russiansuperglue.com/ru/tasks/task_info/RCB).
...
Это будет отнесено к определенной категории (первой в этом конкретном примере), что позволит вашему боту задать подходящий дополнительный вопрос, т.е. задавать новые вопросы с учетом предыдущих ответов.
